	...
	public static EntityFX spawnParticle(String particleName, double par2, double par4, double par6, double par8, double par10, double par12)
	{
		if (mc != null && mc.renderViewEntity != null && mc.effectRenderer != null)
		{
			...
			else
			{
                ...
                else if (particleName.equals("dripAcid"))
                {
                	var21 = new EntityDropParticleFX(theWorld, par2, par4, par6, ZMaterial.acid);
                }
                else if (particleName.equals("ASuspend"))
                {
                    var21 = new EntityAcidSuspendFX(theWorld, par2, par4, par6, par8, par10, par12);
                }
