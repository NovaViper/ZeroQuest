...
public class GuiForisPack extends GuiContainer
{
    private float xSize_Wolf;
    private float ySize_Wolf;
    private EntityForisZertum wolf;
    private boolean mouseWasDown;
    
    private static final ResourceLocation gui = new ResourceLocation(ZeroQuest.modid + ":" + "textures/gui/petInventoryForis.png");


    public GuiForisPack(InventoryPlayer inventoryplayer, EntityForisZertum entityForisZertum) {
        super(new ContainerForisPack(inventoryplayer, entityForisZertum));
        this.mouseWasDown = false;
        this.wolf = entityForisZertum;
