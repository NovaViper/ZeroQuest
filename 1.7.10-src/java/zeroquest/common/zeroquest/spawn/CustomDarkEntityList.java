...
public class CustomDarkEntityList
{
    ...
    {//TODO Edit this list for more custom eggs for your entity!
        ...
        addMapping(EntityDarkZertum.class, "DarkZertum", 30, 0xCCCCCC, 0x470047);
        addMapping(EntityKurr.class, "Kurr", 31, 0xFF0000, 0x660000);
    }
}