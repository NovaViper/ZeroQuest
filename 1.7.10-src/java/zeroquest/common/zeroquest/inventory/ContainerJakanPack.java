...
*/
public class ContainerJakanPack extends Container {

    private EntityJakan wolf;

    public ContainerJakanPack(InventoryPlayer par1IInventory, EntityJakan entityjakan) {
        wolf = entityjakan;
        int i = 0;
        ...
        for (int j = 0; j < 3; j++)
        {
            ...
            {
                this.addSlotToContainer(new SlotJakanPack(entityjakan.inventory, i, 79 + 18 * i1, 1 + 18 * j + 24, wolf));
                i++;
            }
        }
