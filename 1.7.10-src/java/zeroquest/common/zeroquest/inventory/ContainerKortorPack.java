...
*/
public class ContainerKortorPack extends Container {

    private EntityKortor wolf;

    public ContainerKortorPack(InventoryPlayer par1IInventory, EntityKortor entityKortor) {
        wolf = entityKortor;
        int i = 0;
        ...
        for (int j = 0; j < 3; j++)
        {
            ...
            {
                this.addSlotToContainer(new SlotKortorPack(entityKortor.inventory, i, 79 + 18 * i1, 1 + 18 * j + 24, wolf));
                i++;
            }
        }
