...
*/
public class ContainerIcePack extends Container {

    private EntityIceZertum wolf;

    public ContainerIcePack(InventoryPlayer par1IInventory, EntityIceZertum entityIceZertum) {
        wolf = entityIceZertum;
        int i = 0;
        ...
        for (int j = 0; j < 3; j++)
        {
            ...
            {
                this.addSlotToContainer(new SlotIcePack(entityIceZertum.inventory, i, 79 + 18 * i1, 1 + 18 * j + 24, wolf));
                i++;
            }
        }
