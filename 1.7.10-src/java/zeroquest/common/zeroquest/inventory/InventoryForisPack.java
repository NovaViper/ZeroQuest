...
public class InventoryForisPack implements IInventory {

public ItemStack[] inventorySlots;
    private EntityForisZertum dog;

    public InventoryForisPack(EntityForisZertum entityForisZertum) {
        this.dog = entityForisZertum;
