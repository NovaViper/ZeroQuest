...
public class BlockDarkaxFire extends BlockFire
{
    @Deprecated
	...
	public void onBlockAdded(World par1World, int par2, int par3, int par4)
	{
		...
		if ((par1World.getBlock(par2, par3 - 1, par4) != ModBlocks.darkaxStone) || (!((BlockPortalDarkax)ModBlocks.portalDarkax).func_150000_e(par1World, par2, par3, par4)))
		{
    ...
    public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_)
    {
        ...
        if (!World.doesBlockHaveSolidTopSurface(p_149734_1_, p_149734_2_, p_149734_3_ - 1, p_149734_4_) && !((BlockDarkaxFire)ModBlocks.darkaxFire).canCatchFire(p_149734_1_, p_149734_2_, p_149734_3_ - 1, p_149734_4_, UP))
        {
            if (((BlockDarkaxFire)ModBlocks.darkaxFire).canCatchFire(p_149734_1_, p_149734_2_ - 1, p_149734_3_, p_149734_4_, EAST))
            {
                for (l = 0; l < 2; ++l)
                {
            ...
            if (((BlockDarkaxFire)ModBlocks.darkaxFire).canCatchFire(p_149734_1_, p_149734_2_ + 1, p_149734_3_, p_149734_4_, WEST))
            {
                for (l = 0; l < 2; ++l)
                {
            ...
            if (((BlockDarkaxFire)ModBlocks.darkaxFire).canCatchFire(p_149734_1_, p_149734_2_, p_149734_3_, p_149734_4_ - 1, SOUTH))
            {
                for (l = 0; l < 2; ++l)
                {
            ...
            if (((BlockDarkaxFire)ModBlocks.darkaxFire).canCatchFire(p_149734_1_, p_149734_2_, p_149734_3_, p_149734_4_ + 1, NORTH))
            {
                for (l = 0; l < 2; ++l)
                {
                    f = (float)p_149734_2_ + p_149734_5_.nextFloat();
            ...
            if (((BlockDarkaxFire)ModBlocks.darkaxFire).canCatchFire(p_149734_1_, p_149734_2_, p_149734_3_ + 1, p_149734_4_, DOWN))
            {
                for (l = 0; l < 2; ++l)
                {
                    f = (float)p_149734_2_ + p_149734_5_.nextFloat();
