...
public class GenLayerNileHills extends GenLayer
{
    private static final Logger logger = LogManager.getLogger();
    private GenLayer field_151628_d;
    private static final String __OBFID = "CL_00000563";

    public GenLayerNileHills(long p_i45479_1_, GenLayer p_i45479_3_, GenLayer p_i45479_4_)
    {
        super(p_i45479_1_);
        ...
        for (int i1 = 0; i1 < p_75904_4_; ++i1)
        {
            for (int j1 = 0; j1 < p_75904_3_; ++j1)
            {
                ...
                else
                {
                    ...
                    else if (k1 == ModBiomes.blueMegaTaiga.biomeID)
                    {
                        i2 = ModBiomes.blueMegaTaigaHills.biomeID;
                    }
                    else if (k1 == ModBiomes.blueColdTaiga.biomeID)
                    {
                    ...
                    {
                        i2 = ModBiomes.nileMountainsPlus.biomeID;
                    }
                    else if (k1 == ModBiomes.nileSavanna.biomeID)
                    {
                        i2 = ModBiomes.nileSavannaPlateau.biomeID;
                    }
                    else if (compareBiomesById(k1, ModBiomes.nileMesaPlateau_F.biomeID))
                    {
