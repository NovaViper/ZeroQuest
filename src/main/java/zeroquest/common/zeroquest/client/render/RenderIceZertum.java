...
import common.zeroquest.client.model.ModelIceZertum;
...
public class RenderIceZertum extends RenderLiving
{
    ...
    private static final ResourceLocation anrgyIceZertumTextures = new ResourceLocation(ZeroQuest.modid + ":" + "textures/entity/zertum/izertum_angry.png");
    ...
    public RenderIceZertum(ModelIceZertum par1ModelZertum, float par3)
    {
    ...
    protected ResourceLocation func_110914_a(EntityIceZertum par1Entityzertum)
    {
        return par1Entityzertum.isTamed() ? tamedIceZertumTextures : (par1Entityzertum.isAngry() ? anrgyIceZertumTextures : IceZertumTextures);
    }
    ...
    {
        return this.func_82447_a((EntityIceZertum)par1EntityLivingBase, par2, par3);
    }
    ...
    {
        return this.func_110914_a((EntityIceZertum)par1Entity);
    }
}
