package common.zeroquest.client.render.model;
...
public class ModelForisZertum extends ModelBase
{
  //fields
    ModelRenderer Nose;
    ModelRenderer Ear2;
  ...
  {
      EntityForisZertum entityzertum = (EntityForisZertum)par1EntityLivingBase;
