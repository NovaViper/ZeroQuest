...
public class LayerMetalZertumCollarDying implements LayerRenderer
{
    ...
    public LayerMetalZertumCollarDying(RenderMetalZertum renderMetalZertum)
    {
        this.field_177146_b = renderMetalZertum;
    }
