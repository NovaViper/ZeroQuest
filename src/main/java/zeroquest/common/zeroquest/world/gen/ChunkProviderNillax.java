...
import common.zeroquest.world.gen.feature.WorldGenNillaxLakes;
...
public class ChunkProviderNillax implements IChunkProvider
{
    ...
    private MapGenBase caveGenerator = new MapGenNillaxCaves();
    ...
    private MapGenBase ravineGenerator = new MapGenNillaxRavine();
                    ...
                    for (int l2 = 0; l2 < 8; ++l2)
                    {
                        ...
                        for (int i3 = 0; i3 < 4; ++i3)
                        {
                            ...
                            for (int k3 = 0; k3 < 4; ++k3)
                            {
                                ...
                                {
                                    p_147424_3_[j3 += short1] = ModLiquids.niliBlock;
                                }
                                else
                                {
    ...
    public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_)
    {
        ...
        if (biomegenbase != ModBiomes.destroZone && biomegenbase != ModBiomes.destroZoneHills && !flag && this.rand.nextInt(4) == 0
            && TerrainGen.populate(p_73153_1_, worldObj, rand, p_73153_2_, p_73153_3_, flag, LAKE))
        {
            k1 = k + this.rand.nextInt(16) + 8;
            l1 = this.rand.nextInt(256);
            i2 = l + this.rand.nextInt(16) + 8;
            (new WorldGenNillaxLakes(ModLiquids.niliBlock)).generate(this.worldObj, this.rand, k1, l1, i2);
        }
        ...
        if (TerrainGen.populate(p_73153_1_, worldObj, rand, p_73153_2_, p_73153_3_, flag, LAVA) && !flag && this.rand.nextInt(8) == 0)
        {
            ...
            {
                (new WorldGenNillaxLakes(Blocks.lava)).generate(this.worldObj, this.rand, k1, l1, i2);
            }
        }
