...
import common.zeroquest.world.gen.feature.WorldGenDarkaxLakes;
...
public class ChunkProviderDarkax implements IChunkProvider
{
                    ...
                    for (int l2 = 0; l2 < 8; ++l2)
                    {
                        ...
                        for (int i3 = 0; i3 < 4; ++i3)
                        {
                            ...
                            for (int k3 = 0; k3 < 4; ++k3)
                            {
                                ...
                                {
                                    p_147424_3_[j3 += short1] = ModLiquids.acidBlock;
                                }
                                else
                                {
    ...
    public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_)
    {
            ...
            && TerrainGen.populate(p_73153_1_, worldObj, rand, p_73153_2_, p_73153_3_, flag, LAKE))
        {
            ...
            (new WorldGenDarkaxLakes(ModLiquids.acidBlock)).generate(this.worldObj, this.rand, k1, l1, i2);
        }
