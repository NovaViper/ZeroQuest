...
public class InventoryKortorPack implements IInventory {

public ItemStack[] inventorySlots;
    private EntityKortor dog;

    public InventoryKortorPack(EntityKortor entityKortor) {
        this.dog = entityKortor;
