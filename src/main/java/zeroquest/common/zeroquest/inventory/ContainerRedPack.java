...
public class ContainerRedPack extends Container {


    private EntityRedZertum wolf;


    public ContainerRedPack(InventoryPlayer par1IInventory, EntityRedZertum entitydtdoggy) {
        wolf = entitydtdoggy;
        int i = 0;
