...
*/
public class ContainerForisPack extends Container {

    private EntityForisZertum wolf;

    public ContainerForisPack(InventoryPlayer par1IInventory, EntityForisZertum entityForisZertum) {
        wolf = entityForisZertum;
        int i = 0;
        ...
        for (int j = 0; j < 3; j++)
        {
            ...
            {
                this.addSlotToContainer(new SlotForisPack(entityForisZertum.inventory, i, 79 + 18 * i1, 1 + 18 * j + 24, wolf));
                i++;
            }
        }
