...
public class InventoryIcePack implements IInventory {

public ItemStack[] inventorySlots;
    private EntityIceZertum dog;

    public InventoryIcePack(EntityIceZertum entityIceZertum) {
        this.dog = entityIceZertum;
