...
public class EntityCustomIZAIBeg extends EntityAIBase
{
    private EntityIceZertum theWolf;
    ...
    public EntityCustomIZAIBeg(EntityIceZertum p_i1617_1_, float p_i1617_2_)
    {
