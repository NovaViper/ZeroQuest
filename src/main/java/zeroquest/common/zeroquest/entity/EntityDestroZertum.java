...
public class EntityDestroZertum extends EntityCustomTameable
{
    ...
    {
        return EnumDyeColor.byDyeDamage(this.dataWatcher.getWatchableObjectByte(INDEX_BREED) & 15);
    }

    public void setCollarColor(EnumDyeColor collarcolor)
    {
        this.dataWatcher.updateObject(INDEX_BREED, Byte.valueOf((byte)(collarcolor.getDyeDamage() & 15)));
    }
