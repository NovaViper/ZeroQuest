...
public class EntityJakanPrime extends EntityCustomTameable /*implements IRangedAttackMob*/
{
    ...
    public EntityJakanPrime(World p_i1696_1_)
    {
        super(p_i1696_1_);
    ...
    public EntityJakanPrime createChild(EntityAgeable p_90011_1_)
    {
    	EntityJakanPrime entitywolf = new EntityJakanPrime(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal p_70878_1_)
    {
        ...
        else if (!(p_70878_1_ instanceof EntityJakanPrime))
        {
            return false;
        }
        else
        {
        	EntityJakanPrime entitywolf = (EntityJakanPrime)p_70878_1_;
    ...
    public boolean func_142018_a(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_)
    {
        ...
        {
            if (p_142018_1_ instanceof EntityJakanPrime)
            {
            	EntityJakanPrime entitywolf = (EntityJakanPrime)p_142018_1_;
