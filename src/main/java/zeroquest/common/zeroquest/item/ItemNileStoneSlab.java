...
public class ItemNileStoneSlab extends ItemBlock
{
    ...
    public ItemNileStoneSlab(Block block)
    {
        super(block);
        this.field_150949_c = (BlockSlab) ModBlocks.nileStoneSlab;
        this.field_150947_d = (BlockSlab) ModBlocks.nileStoneDoubleSlab;
