...
import net.novaviper.zeroquest.common.message.ZertumMode;
import net.novaviper.zeroquest.common.message.ZertumName;
import net.novaviper.zeroquest.common.message.ZertumObey;
import net.novaviper.zeroquest.common.message.ZertumTalents;
