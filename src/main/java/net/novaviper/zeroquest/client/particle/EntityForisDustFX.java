package net.novaviper.zeroquest.client.particle;
...
public class EntityForisDustFX extends EntityFX
{
    private static final String __OBFID = "CL_00000929";

    public EntityForisDustFX(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double speedIn)
    {
    ...
    public static class Factory implements IParticleFactory
        {
            ...
            {
                return new EntityForisDustFX(worldIn, p_178902_3_, p_178902_5_, p_178902_7_, p_178902_9_, p_178902_11_, p_178902_13_);
            }
        }
    ...
    public static class HappyVillagerFactory implements IParticleFactory
        {
            ...
            public EntityFX getEntityFX(int p_178902_1_, World worldIn, double p_178902_3_, double p_178902_5_, double p_178902_7_, double p_178902_9_, double p_178902_11_, double p_178902_13_, int ... p_178902_15_)
            {
                EntityForisDustFX entityaurafx = new EntityForisDustFX(worldIn, p_178902_3_, p_178902_5_, p_178902_7_, p_178902_9_, p_178902_11_, p_178902_13_);
