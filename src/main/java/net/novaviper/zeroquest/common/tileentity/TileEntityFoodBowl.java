package net.novaviper.zeroquest.common.tileentity;
...
public class TileEntityFoodBowl extends TileEntity implements IUpdatePlayerListBox, IInventory {
    ...
    @Override
    public void update() {
    	List dogList = this.worldObj.getEntitiesWithinAABB(EntityZertumEntity.class, new AxisAlignedBB(this.pos.getX(), this.pos.getY() + 0.5D, this.pos.getZ(), this.pos.getX() + 1.0D, this.pos.getY() + 0.5D + 0.05000000074505806D, this.pos.getZ() + 1.0D).expand(5, 5, 5));
