...
public class ResourceReference {
	...
	private static Hashtable<String, ResourceLocation> zertumMaleTameLayers = new Hashtable<String, ResourceLocation>();
	...
	public static ResourceLocation getZMaleTameLayers(String type) {
		if (!zertumMaleTameLayers.containsKey(type)) {
			zertumMaleTameLayers.put(type, new ResourceLocation(Constants.modid, getZertumGenderTexturePath(type + "zertum_male_tame.png")));
		}
		return zertumMaleTameLayers.get(type);
	}
