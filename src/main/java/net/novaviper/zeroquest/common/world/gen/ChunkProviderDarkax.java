...
import net.novaviper.zeroquest.common.world.gen.structures.MapGenNileVillage;

public class ChunkProviderDarkax implements IChunkProvider
{
    private Random rand;
    ...
    private MapGenNileVillage villageGenerator;
...

    {
        ...
        villageGenerator = (MapGenNileVillage) TerrainGen.getModdedMapGen(villageGenerator, VILLAGE);
    ...
    {
        return null;//return "Stronghold".equals(p_180513_2_) && this.strongholdGenerator != null ? this.strongholdGenerator.getClosestStrongholdPos(worldIn, p_180513_3_) : null;
    }
