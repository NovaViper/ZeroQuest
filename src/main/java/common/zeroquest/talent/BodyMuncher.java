	...
	public int changeFoodValue(EntityZertumEntity dog, ItemStack stack, int foodValue) {
		...
		if(foodValue == 0) {
	        ...
	        if(dog instanceof EntityForisZertum)
	        	if ((stack.getItem() == Items.reeds || stack.getItem() == Items.baked_potato || stack.getItem() == Items.potato ||
	        	stack.getItem() == Items.wheat || stack.getItem() == Items.wheat_seeds || stack.getItem() == Items.carrot ||
	        	stack.getItem() == Items.melon || stack.getItem() == Items.melon_seeds || stack.getItem() == Items.pumpkin_pie ||
	        	stack.getItem() == Items.pumpkin_seeds || stack.getItem() == Items.speckled_melon || 
	        	stack.getItem() == Items.apple || stack.getItem() == Items.golden_apple || stack.getItem() == ModItems.vitoidFruit))
	        		foodValue = 30 + 3 * level;
