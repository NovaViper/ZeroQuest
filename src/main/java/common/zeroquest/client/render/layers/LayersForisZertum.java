...
public class LayersForisZertum implements LayerRenderer {
	...
	private final RenderForisZertum renderer;
		...
		if (!entity.isInvisible()) {
			if (!entity.hasEvolved()) {
				...
				if (entity.getGender() == true) {
					if (entity.isTamed()) {
						this.renderer.bindTexture(ResourceReference.getZMaleTameLayers("f"));
						GlStateManager.color(1f, 1f, 1f);
						this.renderer.getMainModel().render(entity, par1, par2, par4, par5, par6, par7);
					}
					else {
						this.renderer.bindTexture(ResourceReference.getZMaleLayers("f"));
						GlStateManager.color(1f, 1f, 1f);
						this.renderer.getMainModel().render(entity, par1, par2, par4, par5, par6, par7);
					}
				}
				...
				if (entity.getGender() == true) {
					if (entity.isTamed()) {
						this.renderer.bindTexture(ResourceReference.getZEMaleLayers("f"));
						GlStateManager.color(1f, 1f, 1f);
						this.renderer.getMainModel().render(entity, par1, par2, par4, par5, par6, par7);
					}
				}
				...
				if (entity.getGender() == true) {
					this.renderer.bindTexture(ResourceReference.getZFinalMaleLayers("f"));
					GlStateManager.color(1f, 1f, 1f);
					this.renderer.getMainModel().render(entity, par1, par2, par4, par5, par6, par7);
				}
			}
