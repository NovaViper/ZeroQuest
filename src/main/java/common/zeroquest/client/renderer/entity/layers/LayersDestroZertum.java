...
public class LayersDestroZertum implements LayerRenderer {
	...
	private static final ResourceLocation ZertumMaleTexture = new ResourceLocation(Constants.modid + ":" + "textures/entity/zertum/gender/deszertum_male.png");
	private static final ResourceLocation ZertumTamedMaleTexture = new ResourceLocation(Constants.modid + ":" + "textures/entity/zertum/gender/deszertum_male_tame.png");
	private static final ResourceLocation EvolvedZertumMaleTexture = new ResourceLocation(Constants.modid + ":" + "textures/entity/zertum/evo/gender/deszertum_male.png");
	private final RenderDestroZertum field_177146_b;
	private static final String __OBFID = "CL_00002405";

	public LayersDestroZertum(RenderDestroZertum p_177145_1_) {
		this.field_177146_b = p_177145_1_;
	}

	public void func_177145_a(EntityDestroZertum entity, float par1, float par2, float par3, float par4, float par5, float par6, float par7) {
		if (!entity.hasEvolved()) {
			...
			if (entity.isTamed() && entity.getHealth() <= DataValues.lowHP && !entity.isInvisible()) {
			...
			if (entity.getGender() == true && !entity.isInvisible()) {
				this.field_177146_b.bindTexture(ZertumMaleTexture);
				GlStateManager.color(1f, 1f, 1f);
				this.field_177146_b.getMainModel().render(entity, par1, par2, par4, par5, par6, par7);
			}
			if (entity.isTamed() && entity.getGender() == true && !entity.isInvisible()) {
				this.field_177146_b.bindTexture(ZertumTamedMaleTexture);
				GlStateManager.color(1f, 1f, 1f);
				this.field_177146_b.getMainModel().render(entity, par1, par2, par4, par5, par6, par7);
			}
		}
			...
			if (entity.getGender() == true && !entity.isInvisible()) {
				this.field_177146_b.bindTexture(EvolvedZertumMaleTexture);
				GlStateManager.color(1f, 1f, 1f);
				this.field_177146_b.getMainModel().render(entity, par1, par2, par4, par5, par6, par7);
			}
		}
	...
	public void doRenderLayer(EntityLivingBase entity, float par1, float par2, float par3, float par4, float par5, float par6, float par7) {
		this.func_177145_a((EntityDestroZertum) entity, par1, par2, par3, par4, par5, par6, par7);
	}
}
