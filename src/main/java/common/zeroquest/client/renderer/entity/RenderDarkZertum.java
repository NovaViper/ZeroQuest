...
public class RenderDarkZertum extends RenderLiving
{
    ...
    private static final ResourceLocation evolvedDarkZertumTextures = new ResourceLocation(Constants.modid + ":" + "textures/entity/zertum/evo/dzertum.png");
    private static final ResourceLocation evolvedTamedDarkZertumTextures = new ResourceLocation(Constants.modid + ":" + "textures/entity/zertum/evo/dzertum_tame.png");
    
    public RenderDarkZertum(RenderManager render, ModelBase base, float par1){
    
        super(render, base, par1);
        this.addLayer(new LayersDarkZertum(this));
    }

    public void func_177135_a(EntityDarkZertum entity, double par1, double par2, double par3, float par4, float par5)
    {
        if (entity.isWolfWet())
        {
    ...
    protected ResourceLocation getEntityTexture(EntityDarkZertum entity)
    {
    	if(!entity.hasEvolved()){
    		if(entity.isTamed()){
    			return tamedDarkZertumTextures;
    		}else if(entity.isAngry()){
    			return angryDarkZertumTextures;
    		}else if(!entity.isTamed() && !entity.isAngry()){
    			return darkZertumTextures;
    		}
    	}else if(entity.hasEvolved()){
    		if(entity.isTamed()){
    			return evolvedTamedDarkZertumTextures;
    		}else if(!entity.isTamed() && !entity.isAngry()){
    			return evolvedDarkZertumTextures;
    		}
    	}
		return null;
    }
    ...
    {
        this.func_177135_a((EntityDarkZertum)entity, par1, par2, par3, par4, par5);
    }
