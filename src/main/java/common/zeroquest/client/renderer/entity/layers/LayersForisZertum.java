...
public class LayersForisZertum implements LayerRenderer {
	...
	private static final ResourceLocation ZertumMaleTexture = new ResourceLocation(Constants.modid + ":" + "textures/entity/zertum/gender/fzertum_male.png");
	private static final ResourceLocation ZertumTamedMaleTexture = new ResourceLocation(Constants.modid + ":" + "textures/entity/zertum/gender/fzertum_male_tame.png");
	private static final ResourceLocation EvolvedZertumMaleTexture = new ResourceLocation(Constants.modid + ":" + "textures/entity/zertum/evo/gender/fzertum_male.png");
	private final RenderForisZertum field_177146_b;
	private static final String __OBFID = "CL_00002405";

	public LayersForisZertum(RenderForisZertum p_177145_1_) {
		this.field_177146_b = p_177145_1_;
	}

	public void func_177145_a(EntityForisZertum entity, float par1, float par2, float par3, float par4, float par5, float par6, float par7) {
	...
	public void doRenderLayer(EntityLivingBase entity, float par1, float par2, float par3, float par4, float par5, float par6, float par7) {
		this.func_177145_a((EntityForisZertum) entity, par1, par2, par3, par4, par5, par6, par7);
	}
}
