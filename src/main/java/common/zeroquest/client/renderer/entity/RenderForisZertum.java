...
import common.zeroquest.client.renderer.entity.layers.LayersForisZertum;
...
public class RenderForisZertum extends RenderLiving
{
    ...
    private static final ResourceLocation evolvedZertumTextures = new ResourceLocation(Constants.modid + ":" + "textures/entity/zertum/evo/fzertum.png");
    private static final ResourceLocation evolvedTamedZertumTextures = new ResourceLocation(Constants.modid + ":" + "textures/entity/zertum/evo/fzertum_tame.png");
    ...
    protected ResourceLocation getEntityTexture(EntityForisZertum entity)
    {
    	if(!entity.hasEvolved()){
    		if(entity.isTamed()){
    			return tamedForisZertumTextures;
    		}else if(entity.isAngry()){
    			return angryForisZertumTextures;
    		}else if(!entity.isTamed() && !entity.isAngry()){
    			return forisZertumTextures;
    		}
