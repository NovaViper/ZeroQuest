...
public class LayersMetalZertum implements LayerRenderer {
	...
	private static final ResourceLocation ZertumMaleTexture = new ResourceLocation(Constants.modid + ":" + "textures/entity/zertum/gender/mzertum_male.png");
	private static final ResourceLocation ZertumTamedMaleTexture = new ResourceLocation(Constants.modid + ":" + "textures/entity/zertum/gender/mzertum_male_tame.png");
	private static final ResourceLocation EvolvedZertumMaleTexture = new ResourceLocation(Constants.modid + ":" + "textures/entity/zertum/evo/gender/mzertum_male.png");
