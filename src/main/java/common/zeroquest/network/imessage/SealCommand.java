			...
			if(stack.getItem() == ModItems.commandSeal) {
				...
				if(message.commandId == 1)
				{
					...
					else if(message.commandId == 2)
					{
				        ...
				        if(isDog)
				        {
				        	player.addChatMessage(ChatHelper.getChatComponentTranslation("command.stay"));
				        }
					}
					else if(message.commandId == 3)
					{
				        ...
				        if(isDog)
				        {
				        	player.addChatMessage(ChatHelper.getChatComponentTranslation("command.ok"));
				        }
					}
					else if(message.commandId == 4)
					{
				        ...
				        if(isDog)
				        {
				        	player.addChatMessage(ChatHelper.getChatComponentTranslation("command.heel"));
				        }
					}
