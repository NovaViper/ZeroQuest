...
import common.zeroquest.world.gen.WorldGenNileTrees;
...
public class BlockNileSapling extends BlockFlower
{
    public static final String[] WOOD_TYPES = new String[] {"nile"};
    @SideOnly(Side.CLIENT)
    private Icon[] saplingIcon;

    public BlockNileSapling(int par1)
    {
        super(par1);
        float f = 0.4F;
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.saplingIcon[i] = par1IconRegister.registerIcon("Zero_Quest:sapling_" + WOOD_TYPES[i]);
        }
    }
}
