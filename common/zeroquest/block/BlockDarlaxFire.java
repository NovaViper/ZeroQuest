...
public class BlockDarlaxFire extends BlockFire
{
	private int[] chanceToEncourageFire = new int[256];
	private int[] abilityToCatchFire = new int[256];


	public BlockDarlaxFire(int par1)
	{
		super(par1);
	...
	public void onBlockAdded(World par1World, int par2, int par3, int par4)
	{
		...
		if ((par1World.getBlockId(par2, par3 - 1, par4) != ModBlocks.darlaxStone.blockID) || (!((BlockTeleporter2)ModBlocks.blockTeleporter2).tryToCreatePortal(par1World, par2, par3, par4)))
		{
			if ((!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4)) && (!canNeighborBurn(par1World, par2, par3, par4)))
			{
				par1World.setBlockToAir(par2, par3, par4);
	...
	public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
	{
		...
		if ((!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4)) && (!((BlockDarlaxFire)ModBlocks.darlaxFire).canBlockCatchFire(par1World, par2, par3 - 1, par4, ForgeDirection.UP)))
		{
			if (((BlockDarlaxFire)ModBlocks.darlaxFire).canBlockCatchFire(par1World, par2 - 1, par3, par4, ForgeDirection.EAST))
			{
				for (int l = 0; l < 2; l++)
				{
			...
			if (((BlockDarlaxFire)ModBlocks.darlaxFire).canBlockCatchFire(par1World, par2 + 1, par3, par4, ForgeDirection.WEST))
			{
				for (int l = 0; l < 2; l++)
				{
			...
			if (((BlockDarlaxFire)ModBlocks.darlaxFire).canBlockCatchFire(par1World, par2, par3, par4 - 1, ForgeDirection.SOUTH))
			{
				for (int l = 0; l < 2; l++)
				{
			...
			if (((BlockDarlaxFire)ModBlocks.darlaxFire).canBlockCatchFire(par1World, par2, par3, par4 + 1, ForgeDirection.NORTH))
			{
				for (int l = 0; l < 2; l++)
				{
					float f = par2 + par5Random.nextFloat();
			...
			if (((BlockDarlaxFire)ModBlocks.darlaxFire).canBlockCatchFire(par1World, par2, par3 + 1, par4, ForgeDirection.DOWN))
			{
				for (int l = 0; l < 2; l++)
				{
					float f = par2 + par5Random.nextFloat();
