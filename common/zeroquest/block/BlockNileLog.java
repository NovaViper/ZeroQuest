...
public class BlockNileLog extends BlockRotatedPillar
{
    /** The type of tree this log came from. */
    public static final String[] woodType = new String[] {"nile"};
    @SideOnly(Side.CLIENT)
    private Icon[] field_111052_c;
    @SideOnly(Side.CLIENT)
    private Icon[] tree_top;

    public BlockNileLog(int par1)
    {
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.field_111052_c[i] = par1IconRegister.registerIcon("Zero_Quest:log_" + woodType[i]);
            this.tree_top[i] = par1IconRegister.registerIcon("Zero_Quest:log_" + woodType[i] + "_top");
        }
    }
