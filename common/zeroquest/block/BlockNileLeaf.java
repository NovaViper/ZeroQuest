...
import common.zeroquest.world.ColorizeLeaves;
...
public class BlockNileLeaf extends BlockLeavesBase implements IShearable
{
    public static final String[] LEAF_TYPES = new String[] {"nile"};
    public static final String[][] field_94396_b = new String[][] {{"leaves_nile"}, {"leaves_nile_opaque"}};
    ...
    {
    	 if ((par1 & 3) == 0) {
    	        return ColorizeLeaves.getFoliageColorNile();
    	 }
    	 else {
    		 	return ColorizeLeaves.getFoliageColorNile();
    	 }
    ...
    {
        return ModBlocks.nileSapling.blockID;
    }
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        for (int i = 0; i < field_94396_b.length; ++i)
        {
            ...
            {
                this.iconArray[i][j] = par1IconRegister.registerIcon("Zero_Quest:" + field_94396_b[i][j]);
            }
        }
    }
