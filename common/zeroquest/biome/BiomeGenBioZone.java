...
public class BiomeGenBioZone extends BiomeGenBase {
	...
	public BiomeGenBioZone(int id) {
        super(id);
        //topBlock = (byte)ZeroQuest.nileGrass.blockID;
        //fillerBlock = (byte)ZeroQuest.nileDirt.blockID;
    ...
    public int getBiomeGrassColor(){return 0x009900;}
    	@SideOnly(Side.CLIENT)
	public int getBiomeFoliageColor(){return 0x009900;}
	@SideOnly(Side.CLIENT)
