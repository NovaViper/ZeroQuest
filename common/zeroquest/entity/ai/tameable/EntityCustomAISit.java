...
public class EntityCustomAISit extends EntityAIBase
{
    private EntityCustomTameable theEntity;

    /** If the EntityTameable is sitting. */
    private boolean isSitting;

    public EntityCustomAISit(EntityCustomTameable entityCustomTameable)
    {
        this.theEntity = entityCustomTameable;
        this.setMutexBits(5);
    }
