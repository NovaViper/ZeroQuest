...
public class EntityDZAIBeg extends EntityAIBase
{
    private EntityDarkZertum theWolf;
    private EntityPlayer thePlayer;
    private World worldObject;
    private float minPlayerDistance;
    private int field_75384_e;

    public EntityDZAIBeg(EntityDarkZertum par1EntityDZertum, float par2)
    {
        this.theWolf = par1EntityDZertum;
        this.worldObject = par1EntityDZertum.worldObj;
