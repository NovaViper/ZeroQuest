...
public class EntityCustomAIOwnerHurtByTarget extends EntityAITarget
{
    EntityCustomTameable theDefendingTameable;
    EntityLivingBase theOwnerAttacker;
    private int field_142051_e;

    public EntityCustomAIOwnerHurtByTarget(EntityCustomTameable par1EntityTameable)
    {
