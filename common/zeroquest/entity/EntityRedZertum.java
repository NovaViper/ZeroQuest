...
public class EntityRedZertum extends EntityCustomTameable
{
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.getAttackTarget() == null && isTamed() && 15 > 0) { //TODO
    ...
    public boolean attackEntityAsMob(Entity par1Entity)
    {
        ...
        if (par1Entity instanceof EntityLivingBase)
        {
            ...
            i += EnchantmentHelper.getFireAspectModifier(this);
        }
    ...
    */
	 ...
	 public boolean canMateWith(EntityAnimal par1EntityAnimal)
	 {
		 ...
		 else if (!(par1EntityAnimal instanceof EntityRedZertum))
		 {
			 return false;
		 }
		 else
		 {
			 EntityRedZertum var2 = (EntityRedZertum)par1EntityAnimal;
