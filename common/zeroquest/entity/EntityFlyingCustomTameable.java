 ...
 */
public abstract class EntityFlyingCustomTameable extends EntityCustomTameable {
    
    private static final int IN_AIR_THRESH = 10;
    
    public static final Attribute MOVE_SPEED_AIR = new RangedAttribute("generic.movementSpeedAir", 1.5, 0.0, Double.MAX_VALUE).func_111117_a("Movement Speed Air").setShouldWatch(true);
    ...
    protected void applyEntityAttributes() {
        ...
        getAttributeMap().func_111150_b(MOVE_SPEED_AIR);
    }
    ...
    private void setTasksEnabled(EntityAITasks tasks, boolean flag) {
        ReflectionHelper.setPrivateValue(EntityAITasks.class, tasks, flag ? 3 : Integer.MAX_VALUE, 4);
    }
