 ...
 */
package common.zeroquest.entity.anim;
 ...
 */
public class JakanAnimator {

    // entity parameters
    private final EntityJakanPrime entity;
    ...
    public JakanAnimator(EntityJakanPrime dragon) {
        this.entity = dragon;
    }
     ...
     */
    /*public void animate(ModelJakanPrime model) {
        ...
        // update flags
        model.Torso.isHidden = entity.isSaddled();
    ...
    /*protected void animHeadAndNeck(ModelJakanPrime model) {
    ...
    protected void animTail(ModelJakanPrime model) {
