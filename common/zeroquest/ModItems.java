...
import common.zeroquest.item.ItemDarkAxe;
import common.zeroquest.item.ItemDarkHoe;
import common.zeroquest.item.ItemDarkPickaxe;
import common.zeroquest.item.ItemDarkShovel;
import common.zeroquest.item.ItemDarkSword;
...
public class ModItems {
	...
	public static void load() {    	
    	//Tools/Weapons//
    	nileSword = new ItemNileSword(5004, ZeroQuest.nileEssenceMaterial).setUnlocalizedName("nileSword").setTextureName(ZeroQuest.modid + ":" + "nileSword");
    	nileAxe = new ItemNileAxe(5005, ZeroQuest.nileEssenceMaterial).setUnlocalizedName("nileAxe").setTextureName(ZeroQuest.modid + ":" + "nileAxe");
    	nilePickaxe = new ItemNilePickaxe(5006, ZeroQuest.nileEssenceMaterial).setUnlocalizedName("nilePickaxe").setTextureName(ZeroQuest.modid + ":" + "nilePickaxe");
    	nileShovel = new ItemNileShovel(5007, ZeroQuest.nileEssenceMaterial).setUnlocalizedName("nileShovel").setTextureName(ZeroQuest.modid + ":" + "nileShovel");
    	nileHoe = new ItemNileHoe(5008, ZeroQuest.nileEssenceMaterial).setUnlocalizedName("nileHoe").setTextureName(ZeroQuest.modid + ":" + "nileHoe");
    	nileBow = new ItemNileBow(5009).setUnlocalizedName("nileBow");
    	darkSword = new ItemDarkSword(5010, ZeroQuest.darkEssenceMaterial).setUnlocalizedName("darkSword").setTextureName(ZeroQuest.modid + ":" + "darkSword");
    	darkAxe = new ItemDarkAxe(5011, ZeroQuest.darkEssenceMaterial).setUnlocalizedName("darkAxe").setTextureName(ZeroQuest.modid + ":" + "darkAxe");
    	darkPickaxe = new ItemDarkPickaxe(5012, ZeroQuest.darkEssenceMaterial).setUnlocalizedName("darkPickaxe").setTextureName(ZeroQuest.modid + ":" + "darkPickaxe");
    	darkShovel = new ItemDarkShovel(5013, ZeroQuest.darkEssenceMaterial).setUnlocalizedName("darkShovel").setTextureName(ZeroQuest.modid + ":" + "darkShovel");
    	darkHoe = new ItemDarkHoe(5014, ZeroQuest.darkEssenceMaterial).setUnlocalizedName("darkHoe").setTextureName(ZeroQuest.modid + ":" + "darkHoe");
    	...
    	darkNileBone = new ItemNileBone(5106).setUnlocalizedName("nileDarkBone").setTextureName(ZeroQuest.modid + ":" + "nileDarkBone");
    	darkEssence = new ItemEssence(5107).setUnlocalizedName("darkEssence").setTextureName(ZeroQuest.modid + ":" + "darkEssence");
    	darkDust = new ItemDust(5108).setUnlocalizedName("darkDust").setTextureName(ZeroQuest.modid + ":" + "darkDust");
    	darkGrain = new ItemGrain(5109).setUnlocalizedName("darkGrain").setTextureName(ZeroQuest.modid + ":" + "darkGrain");
    	animalCage = new ItemCage(5110).setUnlocalizedName("animalCage").setTextureName(ZeroQuest.modid + ":" + "animalCage");
