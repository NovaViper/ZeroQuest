...
public class GenLayerBiomesZeroQuest extends GenLayer {
	...
	protected BiomeGenBase[] allowedBiomes = {ModBiomes.bioZone, ModBiomes.blueNile, ModBiomes.redSeed, ModBiomes.pinkZone, ModBiomes.destroZone, ModBiomes.walSkyland};
