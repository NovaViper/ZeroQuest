...
public class ContainerDarkPack extends Container {


    private EntityDarkZertum wolf;


    public ContainerDarkPack(InventoryPlayer par1IInventory, EntityDarkZertum entitydtdoggy) {
        wolf = entitydtdoggy;
        int i = 0;
        ...
        for (int j = 0; j < 3; j++)
        {
            ...
            {
                this.addSlotToContainer(new SlotDarkPack(entitydtdoggy.inventory, i, 79 + 18 * i1, 1 + 18 * j + 24, wolf));
                i++;
            }
        }
