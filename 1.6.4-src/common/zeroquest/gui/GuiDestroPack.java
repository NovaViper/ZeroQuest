...
public class GuiDestroPack extends GuiContainer
{
    private float xSize_wolf;
    private float ySize_wolf;
    private EntityDestroZertum dog;
    private boolean mouseWasDown;
    
    private static final ResourceLocation gui = new ResourceLocation(ZeroQuest.modid + ":" + "textures/gui/petInventoryDestro.png");


    public GuiDestroPack(InventoryPlayer inventoryplayer, EntityDestroZertum entityzertum) {
        super(new ContainerDestroPack(inventoryplayer, entityzertum));
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        this.fontRenderer.drawString(I18n.getString("Inventory"), 8, this.ySize - 155 + 2, 4210752);
    }
