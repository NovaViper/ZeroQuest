...
public class ChunkProviderNillax implements IChunkProvider
{
	...
	public ChunkProviderNillax(World par1World, long par2, boolean par4) {
						...
						for (int i2 = 0; i2 < 4; ++i2)
						{
							...
							for (int k2 = 0; k2 < 4; ++k2)
							{
								if ((d16 += d15) > 0.0D)
								{
									...
									par3ArrayOfByte[j2 += short1] = (byte)ModBlocks.nileStone.blockID;//
								}
								else if (k1 * 8 + l1 < b2)
								{
			...
			for (int var9 = 0; var9 < 16; var9++)
			{
				...
				for (int var16 = 127; var16 >= 0; var16--)
				{
					...
					else
					{
						...
						/** Main filler block fill's all the underground, replaces block stone **/
						else if (var18 != ModBlocks.nileStone.blockID)
						{
							if (var13 == -1)
							{
								if (var12 == 0)
