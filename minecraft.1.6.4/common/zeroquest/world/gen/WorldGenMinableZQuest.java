...
public class WorldGenMinableZQuest extends WorldGenerator
{
    ...
    public WorldGenMinableZQuest(int par1, int par2)
    {
        this(par1, par2, ModBlocks.nileStone.blockID);
    }


    public WorldGenMinableZQuest(int par1, int par2, int par3)
    {
    ...
    public WorldGenMinableZQuest(int id, int meta, int number, int target)
    {
