...
import common.zeroquest.entity.ai.tameable.EntityDAIBeg;
...
public class EntityDestroZertum extends EntityCustomTameable
{
    ...
    /*protected int getDropItemId()
    {
        ...
        if(rare == 0)
        	return -1;
        if(rare == 5)
        	return ZeroQuest.nileDust.itemID;
        else
        	return ZeroQuest.nileGrains.itemID;
        }*/
    ...
    private void dropItemsInChest(Entity par1Entity, InventoryDestroPack par2AnimalChest)
    {
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        if (this.isTamed())
        {
            if (itemstack != null)
            {
                ...
                {
                   	par1EntityPlayer.openGui(ZeroQuest.instance, CommonProxy.DestroZertumPack, this.worldObj, this.entityId, MathHelper.floor_double(this.posY), MathHelper.floor_double(this.posZ));
        ...
        else if (itemstack != null && itemstack.itemID == ModItems.nileBone.itemID && !this.isAngry())
        {
            if (!par1EntityPlayer.capabilities.isCreativeMode)
            {
                --itemstack.stackSize;
     ...
     */
	 ...
	 public boolean canMateWith(EntityAnimal par1EntityAnimal)
	 {
		 ...
		 else if (!(par1EntityAnimal instanceof EntityDestroZertum))
		 {
			 return false;
		 }
		 else
		 {
			 EntityDestroZertum var2 = (EntityDestroZertum)par1EntityAnimal;
