...
public class EntityDAIBeg extends EntityAIBase
{
    private EntityDestroZertum theWolf;
    private EntityPlayer thePlayer;
    private World worldObject;
    private float minPlayerDistance;
    private int field_75384_e;

    public EntityDAIBeg(EntityDestroZertum par1EntityRedZertum, float par2)
    {
        this.theWolf = par1EntityRedZertum;
        this.worldObject = par1EntityRedZertum.worldObj;
